...
const ApprovedResumes = () => {
    ...
    const fliterCategories = ["all", ...new Set(resumesList?.map((resume) => resume.applyFor ))];
  ...
  return (
    ...
    {/* <div className="flex justify-between items-center pb-4 bg-white p-4">
        <div className="flex">
            ...
            <div id="dropdownAction" className={`absolute z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow ${filter}`} data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style = {{position: "absolute", inset: "0px auto auto 0px", margin: "0px", transform: "translate(0px, 46px)"}}>
                <ul className="py-1 text-sm text-gray-700 border border-gray-300 rounded top-2" aria-labelledby="dropdownFilterButton">
                {
                  fliterCategories.map((category, index) => (
                    <li key={index}>
                        <a href="#" onClick={()=>handleFilter(filter)} className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{category}</a>
                    </li>
                  ))
                }
                </ul>
        ...
        <tbody className="text-sm">
        {
          resumesList?.map((resume) => (
            <tr key={resume._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="py-4 px-6">
                    <button type="button" onClick={()=>handleReject(resume.uniqueID)} className="font-medium text-blue-600 border border-red-300 hover:bg-red-100"><span className="text-red-400 px-2 py-1">Reject</span></button>
                </td>
            </tr>
          ))
        }
...
{/* <div className="overflow-x-auto relative shadow-md sm:rounded-lg">
    <div className="flex justify-between items-center py-4 bg-white dark:bg-gray-800">
        <div>
            ...
            <div id="dropdownAction" className="z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 hidden" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" style = {{position: "absolute", inset: "0px auto auto 0px", margin: "0px", transform: "translate(0px, 46px)"}}>
