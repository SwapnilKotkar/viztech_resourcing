        ...
        <tbody className="text-sm">
        {
          resumesList?.map((resume) => (
            <tr key={resume._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="py-4 px-6">
                    <button type="button" onClick={()=>handleApprove(resume)} className="text-xl text-green-500 md:mr-3 my-1"><BsFillCheckSquareFill/></button>
                    <button type="button" onClick={()=>handleRemove(resume.uniqueID)} className="text-xl text-red-500 md:ml-3 my-1"><BsFillTrashFill/></button>
                </td>
            </tr>
          ))
        }
